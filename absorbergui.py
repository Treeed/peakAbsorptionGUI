...
class ViewData(QtGui.QMainWindow):
    def __init__(self):
        ...
        button_new_target.clicked.connect(absorberfunctions.change)
        ...
        button_reset_roi.clicked.connect(absorberfunctions.reset_roi)
        ...
        button_add_bs.clicked.connect(absorberfunctions.add_bs)
